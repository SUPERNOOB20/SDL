...
struct SDL_Application{
    ...
    void render_witch(int currentFrame){
        ...
        // double floating_offset = SDL_sin(currentFrame / WITCH_FLOATING_SPEED);


        double floating_offset = SDL_sin( ((double) currentFrame) / ((double) WITCH_FLOATING_SPEED) );

        // SDL_Log("Frame #%d: %f", currentFrame, SDL_sin(currentFrame / WITCH_FLOATING_SPEED));
        SDL_Log("Frame #%d: %f", currentFrame, SDL_sin( ((double) currentFrame) / ((double) WITCH_FLOATING_SPEED) ));
